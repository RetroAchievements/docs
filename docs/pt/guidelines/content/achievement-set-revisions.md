...
2. **Entrar em contato** com cada autor ativo do conjunto. Eles podem oferecer insights valiosos ou recursos úteis para sua revisão. **Aguarde** uma resposta (após 72 horas, você pode prosseguir sem resposta).
...
::: info PROPOSTAS DE REVISÃO ANÔNIMAS
...
- Fazer atualizações nas informações da página do jogo e nas imagens de título / captura de tela / capa.
...
2. **Contatar** cada autor ativo do conjunto. Eles podem oferecer insights valiosos sobre as pontuações escolhidas. Não é necessário aguardar uma resposta.
...
5. **Iniciar uma votação** postando links para o ícone/badges antigos e seus concorrentes no canal [`#icon-gauntlet`](https://discord.com/channels/310192285306454017/527943666812321795) no Discord.
...
- Use um modelo para criar a enquete:
  <details>
  <summary>Modelos do Discord</summary>
  📊 Proposta 1 vs. 1:<br>
  `?quickpoll (link da página do jogo/hub) | Atual (link do ícone/badges atuais) | Concorrente (link do ícone/badges concorrente)`<br>
  <br>
  📊 Proposta 1 vs. 2 ou 3:<br>
  `?quickpoll (link da página do jogo/hub) | Atual (link do ícone atual) | Concorrente 1 (link do concorrente 1) | Concorrente 2 (link do concorrente 2) | Concorrente 3 (link do concorrente 3)`<br>
  <br>
  Discord permite apenas 4 imagens por post (ícone atual vs. 3 concorrentes), então se houver pelo menos 5 imagens (ícone atual vs. 4+ concorrentes), faça uma montagem com todos:<br><br>
  📊 Proposta 1 vs. 4+:<br>
  `?quickpoll (link da página do jogo/hub) | Atual | Concorrente 1 | Concorrente 2 | Concorrente 3 | Concorrente 4 | Concorrente 5 | Concorrente 6 (link da montagem com todos os ícones)`<br>
  </details>
