# Regras Globais do Placar e Caça às Conquistas
...
Em casos onde há qualquer script mais complexo do que repetir o mesmo botão em rápida sucessão, isso não é permitido. Veja [Não permitido 6](#not-allowed-6).
