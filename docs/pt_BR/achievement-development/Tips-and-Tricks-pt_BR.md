...
**Link para o texto em inglês:** [Tips and Tricks](Tips-and-Tricks)
...
- **Seja criativo e divertido**: Seja tão criativo quanto possível com achievements. "Beat X sem usar / fazer Y", "Beat X em 5 segundos", "3 heart run". Certifique-se de que os jogadores ocasionais ainda podem obter estes com seu melhor esforço. Não é divertido se for muito difícil para um jogador casual! (Veja: **Dicas de bônus** abaixo para os desafios reais!). Há uma página inteira sobre [Achievement Design](Achievement-Design) que pode dar bons conselhos sobre como pensar sobre bons achievements.
