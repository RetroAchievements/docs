...
- [黄金法则](#golden-rules)
- [开发者必须做到以下事项以保持良好地位](#developers-must-do-the-following-to-keep-in-good-standing)
- [修订 - 处理已有成就的成就集](#revisions---working-on-sets-with-existing-achievements)
- [开发者身份到期](#expiration-of-developer-status)
- [成就所有权](#achievement-ownership)
- [关于开发者行为准则的反馈](#feedback-about-the-developer-code-of-conduct)

## 黄金法则

- 尽可能遵循开发者和内容指南。如有疑问，请询问。
- 尊重 fellow 开发者，以文明方式沟通处理任何问题。
...
- 像维基一样，开发者一旦发布作品，即将其交给社区[随时间接受审核和修改](#achievement-ownership)。
...
虽然原开发者不拥有已发布的成就，但他们在 bug 修复和维护方面仍是 caretaker。若另一开发者修订了成就，他们成为该成就的新 caretaker。
