...
- 不要与以下混淆：
  - 策略：两者都涉及管理角色，但策略涉及管理多个 somewhat 相似的单位，而 RPG 涉及管理少数独特角色
...
- 旨在模拟现实生活活动或主题的游戏
- 尽管真实程度各不相同，但在游戏性方面仍应 resemble 它所代表的活动/主题
- 不要与以下混淆：
...
- 不要与以下混淆：
  ...
  - 角色扮演游戏：两者都涉及管理角色，但 RPG 涉及管理少数独特角色，而策略涉及管理多个 somewhat 相似的单位
