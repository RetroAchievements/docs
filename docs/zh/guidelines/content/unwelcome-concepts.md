...
- 许多点击式冒险游戏和视觉小说通常将玩家死亡与故事联系起来，这可能导致玩家 otherwise 不会目睹的独特场景。
- 如果糟糕表现导致幽默或 otherwise 有趣的游戏内认可，例如因头部中弹过多而获得头盔。
...
如果游戏最终有正式发布，则通常不允许，除非有独特内容。仅作为测试版、演示版或原型存在的游戏通常可以，只要它们实际上可玩（有些原型 barely 符合）。
