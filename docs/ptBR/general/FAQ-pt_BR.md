...
**Link para o texto em inglês:** [FAQ](FAQ)
...
[https://www.youtube.com/watch?v=rKY2mZjurJw](https://www.youtube.com/watch?v=rKY2mZjurJw)
...
Para mais detalhes leia esta página: [Meu jogo não está carregando conquistas](My-game-is-not-loading-achievements).
...
**Que bom!!** O melhor lugar para se iniciar é aqui [Começando como um desenvolvedor de conquistas](Getting-Started-as-an-Achievement-Developer-pt_BR). Uma vez que você se familiarizar com o Memory Inspector e outros diálogos relacionados a conquistas, você pode ir em outros [Documentos para Desenvolvedores](Developer-docs-pt_BR)
