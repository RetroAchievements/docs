...
![RAIntegration download prompt in RALibRetro](/ralibretro-raintegration-download.png)
...
![RAIntegration in BizHawk folder](/bizhawk-raintegration-folder.png)
...
![RAIntegration menu in BizHawk](/bizhawk-raintegration-menu.png)
...
![RAIntegration in DuckStation folder](/duckstation-raintegration-folder.png)
...
![Achievement settings in DuckStation](/duckstation-achievement-settings.png)
...
![RAIntegration menu in DuckStation](/duckstation-raintegration-menu.png)
...
![RAIntegration in PCSX2 folder](/pcsx2-raintegration-folder.png)
...
![RAIntegration parameter in PCSX2 shortcut](/pcsx2-raintegration-shortcut.png)
...
![RAIntegration in PCSX2 config file](/pcsx2-raintegration-config.png)
...
![RAIntegration menu in PCSX2](/pcsx2-raintegration-menu.png)
...
![RAIntegration setting in PPSSPP](/ppsspp-raintegration-setting.png)
...
![RAIntegration menu in PPSSPP](/ppsspp-raintegration-menu.png)
...
![RAIntegration in PPSSPP folder](/ppsspp-raintegration-folder.png)
...
![RAIntegration in Dolphin folder](/dolphin-raintegration-folder.png)

Options can be found under Tools -> Achievements. Here you can enable RetroAchievements and log in.

![Achievement settings in Dolphin](/dolphin-achievement-settings.png)
...
![RAIntegration menu in Dolphin](/dolphin-raintegration-menu.png)
