...
DSi mode can be detected when bit0 & bit1 are 1 at 0x400. This is known to slightly shift memory on some game and so could be used to protect against the mode if needs be.
