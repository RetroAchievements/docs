...
- **0x3ffa8c: DS Game ID** ASCII String that identifies the DS Game being played. Can be used to check which version of a game based on ID (for multi-region support, etc)
