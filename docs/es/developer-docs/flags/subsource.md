...
![`SubSource` negative numbers](/subsource-negative-numbers.png)
...
![`SubSource` negative numbers 2](/subsource-negative-numbers2.png)
...
![`SubSource` negative numbers 3](/subsource-negative-numbers3.png)
