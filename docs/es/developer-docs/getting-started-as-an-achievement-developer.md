...
![memoryinspector](/memoryinspector.png)
...
**Tambien mira**: [Un vistaso al Inspector de Memoria](/es/developer-docs/memory-inspector) y [Tips en la busqueda de Memoria](/es/developer-docs/tips-and-tricks#memory-digging-tips).
...
Puedes encontrar mas utiles [Tips en Busqueda de Memoria aqui](/es/developer-docs/tips-and-tricks#Tips-en-Busqueda-de-Memoria).
...
![achievement_sets](/achievement-sets.png)
...
- **Nota**: usualmente un logro tiene mas de un requisito para evadir que salte en un momento equivocado (por ejemplo: jugando en modo demo). En este ejemplo estamos utilizando solamente un requisito para simplificar la explicacion. Mira mas [Tips en la Creacion de Logros aqui](/es/developer-docs/tips-and-tricks#Tips-en-la-Creacion-de-Logros).
...
- Ten encuenta los [conceptos no-bienvenidos en el diseño de logros](/es/guidelines/developers/code-of-conduct#unwelcome-concepts).
...
Puedes encontrar mas en la [pagina de Tips y Trucos](/es/developer-docs/tips-and-tricks).
...
- Tambien puedes ver algunos ejemplos genericos en la pagina de [Plantillas para Logros](/es/developer-docs/achievement-templates).

- Una vez que hubieras aprendido todas las tecnicas basicas, si quieres obtener el estatus de Desarrollador tienes que seguir los pasos explicados aqui: [Como convertirme en un desarrollador de logros](/es/developer-docs/how-to-become-an-achievement-developer).
