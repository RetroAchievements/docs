...
- [Utilizando SubSource para Contar Incrementos Especificos](SubSource-Flag-es#utilizando-subsource-para-contar-incrementos-especificos)
...
Podría verse un poco confuso a primera vista, pero talvez utilizando un ejemplo de verdad pueda ser todo mas claro. Checa [Evitar el Problema de que un Contador se Incremente Dos Veces en el Mismo Frame](Circumvent-the-Problem-of-a-Counter-Incrementing-Twice-in-the-Same-Frame-es).
