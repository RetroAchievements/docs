...
- [Memory Inspector Dialog](#memory-inspector-dialog)
  - [1. New Search](#1-new-search)
  - [2. Filter](#2-filter)
  - [3. Results](#3-results)
  - [4. Code Notes](#4-code-notes)
  - [5. Memory View](#5-memory-view)
  - [Memory Bookmarks](#memory-bookmarks)
- [Reading Data in the Memory Viewer](#reading-data-in-the-memory-viewer)
  - [Decimal, Binary, and Hexadecimal Notations](#decimal-binary-and-hexadecimal-notations)
  - [Memory Viewer Modes](#memory-viewer-modes)
    - [8-Bit Mode](#8-bit-mode)
      - [16 and 32-Bit Mode](#16-and-32-bit-mode)
  - [Working with Sizes Smaller Than 8-Bit](#working-with-sizes-smaller-than-8-bit)
    - [Single Bits](#single-bits)
    - [Upper4 and Lower4](#upper4-and-lower4)
- [Memory Sizes Diagram](#memory-sizes-diagram)
